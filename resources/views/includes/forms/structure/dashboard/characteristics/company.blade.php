<form action="{{ route('structure.dashboard.profile.update.company', auth()->user()->userStructure->structure) }}" method="POST">
    @csrf
    <div class="row">
        <div class="col m-3 card">
            <div class="card-body">
                ...
                <div class="form-check">
                    ...
                    <label for="partnership">@lang('structure/data.company.partnership')</label>
                </div>
                <div class="form-check">
                    <input type="checkbox" name="accept_offers" id="accept_offers" value="1" {{ $structure->data->accept_offers ? 'checked' : '' }} />
                    <label for="accept_offers">@lang('structure/data.company.accept_offers')</label>
                </div>
                <div class="form-check">
                    <input type="checkbox" name="bank_funding" id="bank_funding" value="1" {{ $structure->data->bank_funding ? 'checked' : '' }}/>
                    <label for="bank-funding">@lang('structure/data.company.bank_funding')</label>
                </div>
                <div class="form-group row">
                    <label for="turnover_projection" class="col-sm-2 col-form-label">@lang('structure/data.company.turnover_projection')</label>
                    <div class="col-sm-10">
                ...
                <div class="form-group row">
                    <label for="ebitda" class="col-sm-2 col-form-label">@lang('structure/data.company.ebitda')</label>
                    <div class="col-sm-10">
                        <input type="number" class="form-control" id="ebitda" name="ebitda" value="{{ $structure->data->ebitda }}" />
                    </div>
                </div>
                <div class="form-group row">
                    <label for="clients_number" class="col-sm-2 col-form-label">@lang('structure/data.company.clients_number')</label>
                    <div class="col-sm-10">
                        <input type="number" class="form-control" id="clients_number" name="clients_number" value="{{ $structure->data->clients_number }}" />
                    </div>
                </div>
                <div class="form-group row">
                    <label for="average_monthly_turnover" class="col-sm-2 col-form-label">@lang('structure/data.company.average_monthly_turnover')</label>
                    <div class="col-sm-10">
                ...
                <div class="form-group row">
                    <label for="gross_margin" class="col-sm-2 col-form-label">@lang('structure/data.company.gross_margin')</label>
                    <div class="col-sm-10">
                        <input type="number" class="form-control" id="gross_margin" name="gross_margin" value="{{ $structure->data->gross_margin }}"/>
                    </div>
                </div>
                <div class="form-group row">
                    <label for="logistic_cost" class="col-sm-2 col-form-label">@lang('structure/data.company.logistic_cost')</label>
                    <div class="col-sm-10">
                        <input type="number" class="form-control" id="logistic_cost" name="logistic_cost" value="{{ $structure->data->logistic_cost }}" />
                    </div>
                </div>
                <div class="form-group row">
                    <label for="marketing_cost" class="col-sm-2 col-form-label">@lang('structure/data.company.marketing_cost')</label>
                    <div class="col-sm-10">
                        <input type="number" class="form-control" id="marketing_cost" name="marketing_cost" value="{{ $structure->data->marketing_cost }}" />
                    </div>
                </div>
                <div class="form-group row">
                    <label for="investment_sought" class="col-sm-2 col-form-label">@lang('structure/data.company.invesment_sought')</label>
                    <div class="col-sm-10">
