...
class ClaimDemandsController extends Controller
{
    ...
    public function validates (Request $request) {
        ...
        DB::table('structures_owners')->insert(['user_id' => $request->input('user_id'), 'structure_id' => $request->input('structure_id'), 'created_at' => Carbon::now()->toDateTimeString(), 'updated_at' => Carbon::now()->toDateTimeString()]);
